 ...
 ********************************************************************************************/
	...
	printf("END OF CLOCK MODEL: only required for time sync purposes\n");
 ...
 ********************************************************************************************/
	printf("AP and STA positioning via the ns-3 Mobility Helper\n");
     ...
     ********************************************************************************************/
	printf("Setting up of WiFi devices, SSIDs, channels, etc\n");
