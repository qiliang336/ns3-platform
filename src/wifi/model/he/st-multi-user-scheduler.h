 ...
 * \ingroup wifi
 *
 * StMultiUserScheduler is a simple OFDMA scheduler that indicates to perform a DL OFDMA
 * transmission if the AP has frames to transmit to at least one station.
 * StMultiUserScheduler assigns RUs of equal size (in terms of tones) to stations to
 ...
 */
class StMultiUserScheduler : public MultiUserScheduler
{
public:
  /**
  ...
  StMultiUserScheduler ();
  virtual ~StMultiUserScheduler ();
