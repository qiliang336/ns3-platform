...
//新增
class MgtTWTReqHeader : public Header
{
public:
  MgtTWTReqHeader ();
  ...
  */
   ...
   * 
  */
  uint16_t GetSpID (void) const;

  /**
   * 
  */
  void SetWakeTime (uint16_t time);

  /**
   * 
  */
  uint16_t GetWakeTime (void) const;

  /**
   * 
  */
  void SetWakeDuration (uint16_t time);

  /**
   * 
  */
  uint16_t GetWakeDuration (void) const;

  /**
   * 
  */
  void SetWakeInterval (uint16_t time);

  /**
   * 
  */
  uint16_t GetWakeInterval (void) const;
...
private:
  ...
  uint16_t m_sp_id;
  uint16_t m_waketime;
  uint16_t m_wakeduration;
  uint16_t m_wakeinterval;
};
