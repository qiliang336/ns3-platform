...
WifiPhy::ConfigureStandard(WifiStandard standard)
{
    ...
    std::cout<<"before:m_standard:"<<m_standard<<std::endl;
    m_standard = standard;
    std::cout<<"after:m_standard:"<<m_standard<<std::endl;
    ...
    m_phyEntities.clear();
    std::cout<<"after clear:m_standard:"<<m_standard<<std::endl<<std::endl;
    switch (standard)
    {
